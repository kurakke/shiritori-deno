(() => {
  ...
  var pe2 = ce2();
  function fe2() {
    return useContext2(ue2) || he2;
  }
  function me2() {
    return useContext2(de2) || pe2;
  }
  function ye(e3) {
    var t2 = useState2(e3.stylisPlugins), n3 = t2[0], s = t2[1], c3 = fe2(), u2 = useMemo2(function() {
      var t22 = c3;
  ...
  function qe2(e3, t2, n3) {
    ...
    var C2, I22 = new se2(n3, g22, o ? e3.componentStyle : void 0), P22 = I22.isStatic && c3.length === 0, O2 = function(e22, t22) {
      return function(e32, t3, n22, r22) {
        ...
        }(Re2(t3, useContext2(Ge2), a2) || E2, t3, o2), y22 = f3[0], g32 = f3[1], S3 = function(e4, t4, n32, r3) {
        ...
        return t3.style && g32.style !== t3.style && (C3.style = v3({}, t3.style, {}, g32.style)), C3.className = Array.prototype.concat(c22, h3, S3 !== h3 ? S3 : null, t3.className, g32.className).filter(Boolean).join(" "), C3.ref = w22, createElement2(_2, C3);
      }(C2, e22, t22, P22);
    };
...
`;
  function App() {
    ...
    const reqData = async (word) => {
      ...
      const sentData = JSON.parse(previousWord)[Math.floor(Math.random() * JSON.parse(previousWord).length)];
